        ...
        <section>
            <div class="jumbotron">
                <div class="container">
                    ...
                    <h2 class="ml-2">Tècnic: gestió i reparació d'equips</h2>
                </div>
            </div>    
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text text-center h3">
                                    <span><br><br><a style="text-decoration:none; color:whitesmoke" href="<spring:url value= '/equips/afegir'/>">
                                            Entrar equip</a><br><br><br></span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-4 col-md-4 col-xl-4 bg-info">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title text-center"></h3>
                                <p class="card-text text-center h3">
                                    <span><br><br><a style="text-decoration:none; color:grey" href="<spring:url value= '/reparacions/llistar'/>">
                                            Llistar reparacions</a><br><br><br></span>
                                </p>
                            </div>
                        </div>
                    </div>
