        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">geec</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="<spring:url value= '/equips/llistar'/>">Equips</a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<spring:url value= '/usuaris/llistar'/>">llistar usuaris</a></li>
                            </ul>
                        </li>
                    </ul>
                       ...
                       <li>
                        ...
                        <li>
                            <form  action="logout" method="GET">
                                <input class="btn-lg btn-link" style="color:crimson;"  type="submit" value="Tancar Sessió">
                            </form>
                        </li>
                    </ul>
                </div><!--/.nav-collapse -->
                    ...
                    <div class="col-4 col-md-4 col-xl-4 bg-success">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title text-center"></h3>
                                <p class="card-text text-center h3">
                                    <span><br><br><a style="text-decoration:none; color:grey" href="<spring:url value= '/usuaris/llistar'/>">
                    ...
                    <div class="col-4 col-md-4 col-xl-4 bg-info">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title text-center"></h3>
                                <p class="card-text text-center h3">
                                    <span><br><br><a style="text-decoration:none; color:grey" href="<spring:url value= '/equips/llistar/'/>">
