            ...
            <section>
                <div class="jumbotron">
                    <div class="container">
                        ...
                        <h1 class="ml-2">Llistat d'espais</h1>
                    </div>
                </div>
            </section>
                ...
                <div id="posTabla" class="table-responsive">
                    <table id="mytable" class="table">
                        ...
                        <th class="text-center" scope="col">
                          <SELECT class="js-example-basic-single" id="selCodi" style="width:50%" onchange="myFunctionEspais()">
                              <OPTION>Codi</OPTION>
                           <c:forEach items="${espais}" var="espai">
                                <OPTION>${espai.codi}</OPTION>
                            </c:forEach>
                            </SELECT>
                        
                        </th>
                        <th class="text-center" scope="col">
                          <SELECT class="js-example-basic-single" id="selPlanta" style="width:50%" onchange="myFunctionEspais()">
                        ...
                        <th class="text-center" scope="col">
                          <SELECT class="js-example-basic-single" id="selZona" style="width:50%" onchange="myFunctionEspais()">
                            <OPTION>Zona</OPTION>
                           <OPTION>A</OPTION>
                             <OPTION>B</OPTION>
                              <OPTION>C</OPTION>
                        ...
                        <th class="text-center" scope="col">
                          <SELECT class="js-example-basic-single" id="selPosicio" style="width:50%" onchange="myFunctionEspais()">
                        ...
                        <c:forEach items="${espais}" var="espai">
                            <tr scope="row" class="table-row-link" id="fila" onclick="window.location = '<spring:url value='/espais/espai' />?codi=${espai.codi}'">
