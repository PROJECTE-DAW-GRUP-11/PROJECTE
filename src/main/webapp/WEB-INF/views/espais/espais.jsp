                ...
                <div id="posTabla" class="table-responsive">
                    <table id="mytable" class="table">
                        ...
                        <th class="text-center" scope="col">
                            <SELECT class="js-example-basic-single" id="selCodi" style="width:100%" onchange="myFunctionEspais()">
                                <OPTION>Codi</OPTION>
                        ...
                        <th class="text-center" scope="col">
                            <SELECT class="js-example-basic-single" id="selPlanta" style="width:100%" onchange="myFunctionEspais()">
                        ...
                        <th class="text-center" scope="col">
                            <SELECT class="js-example-basic-single" id="selZona" style="width:100%" onchange="myFunctionEspais()">
                                <OPTION>Zona</OPTION>
                                <OPTION>A</OPTION>
                                <OPTION>B</OPTION>
                                <OPTION>C</OPTION>
